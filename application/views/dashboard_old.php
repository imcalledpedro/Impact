...
<html lang="pt-BR">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
      <a class="border-radius btn btn-primary" href="#"><i class="fas fa-circle"></i> Impact</a>

            <!-- Notificacoes -->
            <div class="dropdown ml-auto mr-1">
              <a class="btn btn-primary border-radius" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

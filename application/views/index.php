...
<html lang="pt-BR">
  <head>
    ...
    <script src="<?php echo base_url();?>/assets/plugins/dark-mode/dark-mode-switch.min.js"></script>
  ...
  <body class=" mt-5 pt-1">
    <nav class="navbar navbar-expand-lg  fixed-top shadow navbar-light bg-light px-5">
	  ...
	  <a class="navbar-toggler text-primary border-radius border-primary py-2" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          <button id="dark-mode" class="btn btn-info"><i class="fas fa-adjust"></i></button>
        </li>
	    </ul>
	  </div>
	</nav>
    ...
    <section class="mt-5">
        ...
        <div class="col-10 mt-5 mx-auto"><hr></div>

...
<html lang="pt-BR">
  ...
  <body class=" mt-5 pt-1">
    ...
    <nav class="navbar navbar-expand-lg  fixed-top shadow navbar-light bg-light px-5">
    	...
    	<a id="navbar-brand" class="navbar-brand ml-5" href="<?php echo base_url();?>">
          ...
          <div class="card p-5">
              <div class="row">
              		...
              		<div class="col">
              			...
              			<ul class="list-group">
						  <li class="list-group-item">Loja 1<a class="btn btn-info float-right" href="<?php echo $link1; ?>">Acessar</a></li>
						  <li class="list-group-item">Loja 2<a class="btn btn-info float-right" href="<?php echo $link2; ?>">Acessar</a></li>
						  <li class="list-group-item">Loja 3<a class="btn btn-info float-right" href="<?php echo $link3; ?>">Acessar</a></li>
						  <li class="list-group-item">Loja 4<a class="btn btn-info float-right" href="<?php echo $link4; ?>">Acessar</a></li>
						</ul>
              		</div>
